...
export function Footer() {
  return (
    <footer className="bg-[#081B38] text-slate-300 pt-16 pb-8 border-t border-white/10 relative overflow-hidden">
      {/* Subtle background glow effect */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#0F2C59] rounded-full blur-3xl opacity-30 pointer-events-none" />
      <div className="absolute bottom-0 left-10 w-80 h-80 bg-[#00C29A] rounded-full blur-3xl opacity-10 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Link href="/" className="flex items-center gap-3.5 group shrink-0" aria-label="DASAI Inicio">
              <div className="relative h-13 w-13 rounded-full overflow-hidden shadow-lg border-2 border-white/20 group-hover:scale-105 transition-transform bg-white shrink-0">
                <Image
            ...
            <div className="flex items-center space-x-3 pt-2">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-xs font-semibold text-[#FF8A3D]">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/trabaja-con-nosotros" className="hover:text-white transition-colors flex items-center gap-1 text-[#FF8A3D] font-semibold">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/cotizar" className="hover:text-white transition-colors text-emerald-400 font-semibold flex items-center gap-1">
                  Cotizador en Línea
                  <ArrowUpRight className="w-3.5 h-3.5" />
                </Link>
              </li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-slate-300">
              ...
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-[#00C29A] shrink-0" />

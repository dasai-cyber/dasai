      ...
      <Container>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-corporate-lg relative overflow-hidden">
            <Quote className="w-20 h-20 text-[#0F2C59]/5 absolute top-6 right-8 pointer-events-none" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-6 border-t border-slate-100">
              ...
              <div className="flex items-center space-x-2">
                <button
                  onClick={prevSlide}
                  className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-[#0F2C59] hover:text-white transition-colors"

...
export function Hero() {
  return (
    <section className="relative min-h-[85vh] lg:min-h-[88vh] flex items-center bg-gradient-to-b from-[#240046] via-[#3A0CA3] to-[#10002B] text-white overflow-hidden py-16 lg:py-20">
      {/* Background Graphic Grid & Radial Lighting */}
      <div className="absolute inset-0 opacity-15 bg-[radial-gradient(#F72585_1.2px,transparent_1.2px)] [background-size:32px_32px] pointer-events-none" />
      <div className="absolute top-10 left-10 w-96 h-96 bg-[#7209B7] rounded-full blur-[140px] opacity-25 pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[500px] h-[500px] bg-[#F72585] rounded-full blur-[160px] opacity-20 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-[#F72585]/30 backdrop-blur-md">
              <span className="flex h-2.5 w-2.5 relative">
                ...
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#F72585]"></span>
              </span>
              <span className="text-xs font-bold tracking-wide text-pink-100">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-6.5xl font-black tracking-tight leading-[1.08] text-white">
              Movemos tu negocio.{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-pink-100 to-[#F72585]">
                Entregamos confianza.
              </span>
            </h1>

            {/* Subtitle */}
            <p className="text-base sm:text-lg lg:text-xl text-purple-100 font-normal leading-relaxed max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              ...
              <Button
                ...
                variant="outline"
                size="xl"
                className="border-white/30 text-white hover:bg-white hover:text-[#480CA8] text-base"
              >
          ...
          >
            <div className="relative mx-auto max-w-lg lg:max-w-none">
              ...
              <div className="relative aspect-[4/3] w-full rounded-3xl overflow-hidden shadow-2xl border border-purple-500/20 bg-[#1A0033]/80">
                <Image
              ...
              <div className="absolute -bottom-4 -left-4 sm:-left-6 bg-white text-slate-800 p-3.5 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="w-10 h-10 rounded-xl bg-pink-50 text-[#F72585] flex items-center justify-center font-bold">
                ...
                <div>
                  ...
                  <div className="text-sm font-extrabold text-[#480CA8]">
                    45 Unidades en Ruta
                  </div>
                </div>
              </div>
              ...
              <div className="hidden sm:flex absolute -top-4 -right-4 bg-[#240046] text-white p-3.5 rounded-2xl shadow-xl border border-[#F72585]/30 items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#F72585] text-white flex items-center justify-center font-bold">

    ...
    try {
      ...
      const record = await prisma.jobApplication.create({
        data: {
          ...
          message: `Comuna: ${data.communeCity || "N/A"} | Doc Vigente: ${data.vehicleDocValid || "N/A"} | Turnos: ${data.shiftAvailability || "N/A"} | Inicio: ${data.startAvailability || "N/A"} | CV: ${data.cvUpdated || "N/A"} | Notas: ${data.additionalNotes || "Ninguna"}`,
        },
      });
